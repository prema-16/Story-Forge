...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[180px] overflow-hidden rounded-xl border border-white/10 bg-[#0d0d20]/95 backdrop-blur-xl p-1.5 shadow-xl shadow-black/40',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn('px-3 py-1.5 text-xs font-semibold text-white/30 uppercase tracking-wider', className)}
    {...props}
  />
));
